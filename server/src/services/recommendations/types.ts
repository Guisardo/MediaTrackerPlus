 ...
 * All API clients (TMDB, IGDB, OpenLibrary) and WatchlistWriter operate on this common contract.
 */

/**
 * Represents a media item similar to a given source media.
 *
 * This interface is used across all similarity API clients to ensure a consistent
 ...
 * @property mediaType - The type of media: 'movie', 'tv', 'game', or 'book'
 ...
 *                            Each client is responsible for enforcing this invariant before returning.
 *                            Examples:
