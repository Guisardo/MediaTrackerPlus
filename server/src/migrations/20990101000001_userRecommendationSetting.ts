...
export async function down(knex: Knex): Promise<void> {
  ...
  // SQLite requires dropping all FK constraints that reference tables being reconstructed
  // before altering the user table (knex reconstructs the table to drop a column).
  await knex.schema
