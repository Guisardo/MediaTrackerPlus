  ...
  describe('IGDB.similar', () => {
    ...
    test('filters out games with no name', async () => {
      mockedAxios.post
        ...
        .mockResolvedValueOnce({
          status: 200,
          data: [{ id: 1 }, { id: 2, name: 'Valid Game', total_rating: 80 }],
        });
...
const searchResult = [
  {
    ...
    externalPosterUrl:
      'https://images.igdb.com/igdb/image/upload/t_original/co1tmu.jpg',
  ...
  },
  {
    ...
    externalPosterUrl:
      'https://images.igdb.com/igdb/image/upload/t_original/co3dik.jpg',
  ...
  },
  {
    ...
    externalPosterUrl:
      'https://images.igdb.com/igdb/image/upload/t_original/co3dim.jpg',
    genres: ["Hack and slash/Beat 'em up", 'Adventure'],
    url: 'https://en.wikipedia.org/wiki/God_of_War_II',
  ...
  },
  {
    ...
    externalPosterUrl:
      'https://images.igdb.com/igdb/image/upload/t_original/co3die.jpg',
    genres: ["Hack and slash/Beat 'em up", 'Adventure'],
